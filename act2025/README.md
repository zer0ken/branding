...
### ✅️ 적절한 변형
심볼 혹은 로고타입에 포함된 애스터리스크를 사선으로 자르고, 오른쪽에 새로운 디자인 요소를 추가하세요. 아래의 이미지는 추가하는 디자인 요소의 크기나 위치를 어떻게 결정해야할지 설명합니다.
...
### ❌ 로고 사용
로고를 파생시키지 마세요. 파생 CI 디자인을 만들 때에는 심볼과 로고타입만 사용할 것을 권장합니다.

### ❌️ 과도한 변형
기존 심볼 혹은 로고타입을 과도하게 변형하지 마세요. 애스터리스크를 사선으로 자르는 것 이상으로 변형하지 않는 것을 권장합니다.

### ❌ 종횡비
파생 CI 디자인을 만들 때 기존 심볼 혹은 로고타입의 종횡비를 변경하지 마세요.
